...
<!-- Resumo Cards -->
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 lg:gap-8 mb-10">
    ...
    <a href="{{ route('cliente.fines') }}" class="relative overflow-hidden rounded-2xl bg-white p-6 shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-lg hover:border-amber-200 transition group">
        <div class="p-4 bg-amber-50 rounded-xl group-hover:bg-amber-100 transition">
        ...
        <div>
            <p class="text-sm font-medium text-gray-500">Multas Pendentes</p>
            <p class="text-2xl font-bold font-display text-gray-900">{{ $pendingFinesCount ?? 0 }}</p>
        </div>
    </a>
</div>
