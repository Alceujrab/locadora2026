...
@section('content')
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-gray-50">
        ...
        <div class="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 bg-white shadow-[10px_0_30px_rgba(0,0,0,0.02)] z-10">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="text-center">
                    ...
                    <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 font-display">
                        Portal do Cliente
                    </h2>
                ...
                <form class="mt-8 space-y-6" action="{{ route('cliente.login') }}" method="POST">
                    ...
                    <div class="space-y-4 rounded-md shadow-sm">
                        <div>
                            <label for="email" class="block text-sm font-bold text-gray-700 mb-1">E-mail Cadastrado</label>
                            <input id="email" name="email" type="email" autocomplete="email" required 
                                value="{{ old('email') }}"
                                class="relative block w-full rounded-xl border-0 py-3 px-4 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 transition-shadow font-medium" 
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <label for="remember" class="ml-2 block text-sm font-medium text-gray-900">Lembrar de mim</label>
                        </div>

                        <div class="text-sm">
                            <a href="#" class="font-bold text-primary-600 hover:text-primary-500 transition-colors">Esqueceu a senha?</a>
                        </div>
                    </div>

                    <div>
                        <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors mb-4">
                            Acessar o Portal
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500 font-medium">
                        Ainda não é cliente? <a href="{{ route('public.vehicles') }}" class="font-bold text-primary-600 hover:text-primary-500 transition-colors">Alugue um veículo agora</a>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Banner Lado Direito -->
        <div class="hidden lg:flex relative w-full h-full bg-gray-900 items-center justify-center p-12 overflow-hidden">
            <!-- Background Image -->
            ...
            <!-- Graphic Overlay -->
            <div class="absolute inset-0 bg-gradient-to-t from-gray-900/90 to-gray-900/40 mix-blend-multiply"></div>
            ...
            <div class="relative z-10 w-full max-w-lg text-white">
                <blockquote class="space-y-6">
                    ...
                    <footer class="flex items-center space-x-4">
                        ...
                        <div>
                            <div class="text-lg font-bold text-white">Roberto Ferreira</div>
                            <div class="text-sm text-gray-300 font-medium">Cliente Corporativo</div>
                        </div>
                    </footer>
                </blockquote>
                ...
                <div class="mt-12 grid grid-cols-2 gap-6 pt-12 border-t border-white/10">
                    <div>
                        <div class="flex items-center space-x-2 text-primary-300 mb-2">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            <span class="font-bold">100% Seguro</span>
                        </div>
                        <p class="text-sm text-gray-300 font-medium">Seus dados e históricos protegidos.</p>
                    </div>
                    <div>
                        <div class="flex items-center space-x-2 text-primary-300 mb-2">
                            ...
                            <span class="font-bold">Praticidade</span>
                        </div>
                        <p class="text-sm text-gray-300 font-medium">Faturas, Chamados e Contratos em 1 clique.</p>
                    </div>
                </div>
            </div>
        </div>
