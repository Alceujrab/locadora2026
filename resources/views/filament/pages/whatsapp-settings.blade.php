<x-filament-panels::page>
    <form wire:submit="save" class="space-y-6">
        {{-- Conexão WuzAPI --}}
        <x-filament::section
            heading="Conexao com WuzAPI"
            description="Configure a URL da API e o token do usuario criado no WuzAPI (https://github.com/asternic/wuzapi)."
        ...
        >
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Ex: https://wuzapi.seudominio.com.br ou http://localhost:8080</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Token do Usuario</label>
                    <input type="password" wire:model="wuzapi_token" placeholder="token gerado no painel admin do WuzAPI"
                        class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500" />
                    <p class="text-xs text-gray-500 mt-1">Enviado no header <code>token</code> em todas as requisicoes.</p>
                </div>
                <div>
        ...
        {{-- Ativacao --}}
        <x-filament::section
            heading="Ativacao do WhatsApp"
            description="Ative ou desative o envio de notificacoes via WhatsApp para cada modulo do sistema."
        ...
        {{-- Mensagens Padrão --}}
        <x-filament::section
            heading="Mensagens Padrao"
            description="Personalize o cabecalho e rodape das mensagens enviadas por WhatsApp."
